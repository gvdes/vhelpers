          ...
          <q-card-section horizontal>
            <q-card-section>
              <q-form @submit="trySignin" class="q-gutter-lg" >
                <q-input outlined rounded standout="text-primary" placeholder="nick" input-class="fs-inc2 text-center" v-model="auths.nick" type="text" autofocus="" autocapitalize="off" autocomplete="off"/>
                <q-input outlined rounded placeholder="nip" input-class="fs-inc2 text-center" v-model="auths.pass" type="password" />
