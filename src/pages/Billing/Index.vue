    ...
    <q-card class="q-pa-xl q-mx-auto shadow-4" style="max-width: 700px; border-radius: 22px">
      ...
      <q-card-section>
        <q-expansion-item v-if="showExpands.client" v-model="expands.client"
          header-class="text-h6 text-primary text-weight-bold" label="Datos del Cliente" icon="person" expand-separator>
          ...
          <div class="q-gutter-md q-mt-md">
            ...
            <q-input filled dense label="Correo Electrónico" v-model="form.email" :rules="[validEmail]" type="email" />
