...
export default {
  ...
  autocomplete(data) {
    return assist.post(`/Products/autoComplete`, data).then(done => done.data).catch(fail => { return { fail } });
  },
  getProducts(data) {
    return assist.post(`/Products/getProducts`, data).then(done => done.data).catch(fail => { return { fail } });
  },
  searchExact(data) {
  ...
  generatePreviewManual(data) {
    return assist.post(`/Products/previewModel`, data).then(done => done.data).catch(fail => { return { fail } });
  },
}
