...
const vizapi = axios.create({ baseURL: 'http://192.168.10.238:1619/vizapi/public/LVH' }); // pruebas
...
// const assist = axios.create({ baseURL: 'http://192.168.10.238:2902/Assist/public/api'}); //producccion
// const assist = axios.create({ baseURL: 'http://192.168.10.160:1920/Assist/public/api'}); //desarrollo

const assist = axios.create({ baseURL: 'http://192.168.10.238:3530/Assist/public/api'}); //prueba
